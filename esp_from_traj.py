#!/usr/bin/env python
""" Reconstructs quantum system from GPAW .traj file and extracts ESP to phi_grid.csv and phi_grid.cube"""
...
parser = argparse.ArgumentParser(\
    description='Reconstructs quantum system from GPAW .traj file and extracts ESP to phi_grid.csv and phi_grid.cube')
...
struc.set_cell([25,25,25]) # is this necessary after loading?
struc.set_pbc([0,0,0])
struc.center() # is this necessary after loading?
