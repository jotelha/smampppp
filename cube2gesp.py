...
if N > 0:
    ...
    print(" Original grid: {:32,d} points, {} by spatial dimensions".format(int(NX.prod()), NX))

    cube_data = gridInterpolator( X.T )    
    print("Coarsened grid: {:32,d} points, {} by spatial dimensions".format(int(Nx.prod()), Nx))
    ...
    print("on  original grid: data integral {} with {} unit cell".format(Integral, Unit_Cell))
    print("on coarsened grid: data integral {} with {} unit cell".format(integral, unit_cell))
